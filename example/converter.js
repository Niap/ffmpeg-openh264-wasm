...
var ASM_CONSTS = {
  ...
  /** @type {function(...*):?} */
  function _clearFFmpegGlobal(
  ) {
  err('missing function: clearFFmpegGlobal'); abort(-1);
  }

  /** @type {function(...*):?} */
  function _clearFFprobeGlobal(
  ) {
  err('missing function: clearFFprobeGlobal'); abort(-1);
  }
...
var asmLibraryArg = {
  ...
  "abort": _abort,
  "clearFFmpegGlobal": _clearFFmpegGlobal,
  "clearFFprobeGlobal": _clearFFprobeGlobal,
